...
public class HomeForLecturerActivity extends AppCompatActivity {
    @Override
    ...
    public void onBtnQRCodeClick(View view) {
        Intent intent = new Intent(HomeForLecturerActivity.this, QRCodeCreatorActivity.class);
            ...
            DialogInterface.OnClickListener dialogClickListener = (dialog, which) -> {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        startActivity(new Intent(HomeForLecturerActivity.this, LoginActivity.class));
                        finish();
